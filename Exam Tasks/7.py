...
#  From 3 to 5 the gap is 2. From 7 to 11 it is 4. Between 2 and 50 we have the following pairs 
...
# gap of g between the limits m, n if these numbers exist otherwise None
